<p align="center">
  <img src="screenshots/swarm_banner.png" alt="SwarmPilot" width="800"/>
</p>
...
![Main Window — Light Theme](screenshots/main_window_light.png)

![Telemetry Panel](screenshots/telemetry_panel.png)

![HUD Display](screenshots/hud_display.png)

![Formation Panel](screenshots/formation_panel.png)

![Map View with Geofence](screenshots/map_with_geofence.png)

![Connection Dialog](screenshots/connection_dialog.png)
...
![Drone Card](screenshots/drone_card.png)
...
![Formation Modes](screenshots/formation_modes.png)
...
![Collision Alert](screenshots/collision_alert.png)
...
![Geofence Setup](screenshots/geofence_setup.png)
...
![HUD](screenshots/hud_detailed.png)
